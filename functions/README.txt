...
removedDataMNAR_LODparam.m generates missing values for a complete dataset by the MNAR modeling method, with an LOD percentage threshold as an input.
...
kNNData.m imputes data using the original kNN algorithm that skips nearest neighbors with missing values in the same metabolite location as the value in the target sample being imputed.
...
>>>>>>> 35039021985a059efe28e8d264b06d8e21332c7e
